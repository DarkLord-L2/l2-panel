...
// Вызывается только из reports.html. Принимает один скриншот (data URL, base64)
// со списком пати и колонками Килы/Смерти/K:D/PvP урон/PvE урон, отдаёт его в Gemini
// с промптом «верни таблицу как JSON», возвращает распознанные строки. Требует роль
// glavadmin или admin. K:D не запрашивается у модели — это производная величина
...
type StatRow = { nickname: string; kills: number; deaths: number; pvp_damage: number; pve_damage: number };
