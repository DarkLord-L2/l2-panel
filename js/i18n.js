...
(function(){
  ...
  const DICT = {
    ...
    "admin.auditLogHint": [
      "Кто и что менял в Админ-панели — создание/удаление пользователей, смена роли/пати, снятие защиты, сумма налога, включение/выключение разделов. Свежие записи сверху.",
      "Хто і що змінював в Адмін-панелі — створення/видалення користувачів, зміна ролі/паті, зняття захисту, сума податку, увімкнення/вимкнення розділів. Свіжі записи зверху.",
      "Who changed what in the Admin panel — creating/deleting users, role/party changes, removing protection, tax amount, enabling/disabling sections. Newest entries first.",
    ],
    ...
    "admin.auditLoadMore": ["Показать ещё", "Показати ще", "Show more"],
