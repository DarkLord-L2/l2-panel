...
(function(){
  ...
  const DICT = {
    ...
    "trends.attendanceHint": [
      ...
      "Скільки різних ніків відзначилось хоча б на одному заході за тиждень — за останні 12 тижнів.",
      "How many distinct nicknames showed up to at least one event that week — over the last 12 weeks.",
    ],
    "trends.noDataHint": ["За этот период мероприятий ещё не было.", "За цей період заходів ще не було.", "There haven't been any events in this period yet."],
    "trends.taxTitle": ["Сбор налогов по месяцам", "Збір податків за місяцями", "Tax collection by month"],
    "trends.taxHint": [
      "Сколько всего собрано налога (заплативших × сумма налога) — за последние 6 месяцев.",
      "Скільки всього зібрано податку (тих, хто заплатив × сума податку) — за останні 6 місяців.",
      "Total tax collected (payers × tax amount) — over the last 6 months.",
    ],
    "trends.noPaymentsHint": ["За этот период оплат ещё не было.", "За цей період оплат ще не було.", "There haven't been any payments in this period yet."],
    "trends.statTaxTotalLabel": ["Собрано за 6 месяцев", "Зібрано за 6 місяців", "Collected over 6 months"],
    "trends.wheelHint": [
      "Прокрутите колесо мыши над графиком, чтобы сменить масштаб",
      "Прокрутіть колесо миші над графіком, щоб змінити масштаб",
      "Scroll your mouse wheel over the chart to change the scale",
    ],
    "trends.granday": ["По дням", "За днями", "By day"],
    "trends.granweek": ["По неделям", "За тижнями", "By week"],
    "trends.granmonth": ["По месяцам", "За місяцями", "By month"],
    "navgroup.uchet": ["Учёт клана", "Облік клану", "Clan Records"],
    "navgroup.dkp": ["ДКП", "ДКП", "DKP"],
    "shell.signOut": ["Выйти", "Вийти", "Sign out"],
    "shell.navToggle": ["Меню", "Меню", "Menu"],
    ...
    "shell.platformOwnerLabel": ["Владелец платформы", "Власник платформи", "Platform owner"],
    ...
    "census.newCensusBtn": ["+ Новая перепись", "+ Новий перепис", "+ New census"],
    "census.newCensusBtnTitle": ["Начать новую перепись на сегодня", "Почати новий перепис на сьогодні", "Start a new census dated today"],
    "census.historyBtn": ["История", "Історія", "History"],
    "census.entriesHeading": ["Состав переписи {date} (", "Склад перепису {date} (", "Census of {date} ("],
    "census.entriesHeadingSuffix": [")", ")", ")"],
    "census.newSinceHint": [
      "Новых по сравнению с переписью {date}: {n}",
      "Нових порівняно з переписом {date}: {n}",
      "New compared to the {date} census: {n}",
    ],
    "census.emptyCensus": ["На эту дату ещё никто не загружен.", "На цю дату ще нікого не завантажено.", "No one has been uploaded for this date yet."],
    "census.noCensusYet": [
      "Переписей ещё нет — нажмите «+ Новая перепись», чтобы начать.",
      "Переписів ще немає — натисніть «+ Новий перепис», щоб почати.",
      "There are no censuses yet — click “+ New census” to start one.",
    ],
    "census.historyTitle": ["История по нику", "Історія за ніком", "Nickname history"],
    "census.historyHint": [
      "Когда кто впервые засветился в клане и когда виделся в последний раз — по всем переписям. Отсортировано по «Последний раз» — кто давно не появлялся, тот сверху.",
      "Коли хто вперше засвітився в клані і коли бачився востаннє — по всіх переписах. Відсортовано за «Останній раз» — хто давно не з'являвся, той зверху.",
      "When each person first showed up in the clan and when they were last seen — across all censuses. Sorted by “Last seen”, so the longest-absent float to the top.",
    ],
    "census.historySearchPlaceholder": ["Поиск по нику...", "Пошук за ніком...", "Search by nickname..."],
    "census.historyColNick": ["Ник", "Нік", "Nickname"],
    "census.historyColFirst": ["Впервые", "Вперше", "First seen"],
    "census.historyColLast": ["Последний раз", "Востаннє", "Last seen"],
    "census.historyColCount": ["Раз", "Разів", "Times"],
    "census.helpTabsSummary": ["Вкладки-даты", "Вкладки-дати", "Date tabs"],
    "census.helpTabsBody": [
      "Перепись больше не привязана к календарной неделе — каждая загрузка становится своей вкладкой с датой. «+ Новая перепись» начинает вкладку на сегодня, «+ Добавить перепись» дополняет уже открытую вкладку. Новые ники (которых не было в предыдущей по времени переписи) подсвечены зелёной полоской слева.",
      "Перепис більше не прив'язаний до календарного тижня — кожне завантаження стає своєю вкладкою з датою. «+ Новий перепис» починає вкладку на сьогодні, «+ Додати перепис» доповнює вже відкриту вкладку. Нові ніки (яких не було в попередньому за часом переписі) підсвічені зеленою смужкою зліва.",
      "The census is no longer tied to a calendar week — each upload becomes its own dated tab. “+ New census” starts a tab for today, “+ Add census” adds to the currently open tab. New nicknames (not present in the previous census in time) are highlighted with a green stripe on the left.",
    ],
    "census.helpHistorySummary": ["История", "Історія", "History"],
    "census.helpHistoryBody": [
      "Кнопка «История» открывает таблицу по всем переписям сразу: когда каждый ник впервые появился, сколько раз встречался и когда виделся в последний раз. Список отсортирован так, что дольше всех отсутствующие — сверху, удобно для чистки клана.",
      "Кнопка «Історія» відкриває таблицю по всіх переписах одразу: коли кожен нік вперше з'явився, скільки разів зустрічався і коли бачився востаннє. Список відсортовано так, що найдовше відсутні — зверху, зручно для чистки клану.",
      "The “History” button opens a table across all censuses at once: when each nickname first appeared, how many times it showed up, and when it was last seen. Sorted so the longest-absent are on top — handy for cleaning up the roster.",
    ],
    ...
    "payout.tabCurrent": ["Раздача", "Роздача", "Payout"],
    "payout.tabArchive": ["Архив", "Архів", "Archive"],
    "payout.archiveBtn": ["Занести в архив", "Занести в архів", "Add to archive"],
    "payout.archivedOk": ["Занесено в архив.", "Занесено в архів.", "Added to the archive."],
    "payout.archiveFailed": ["Не удалось занести в архив: ", "Не вдалося занести в архів: ", "Failed to add to archive: "],
    "payout.archiveEmpty": [
      "Архив пуст — раздачи туда попадают только по кнопке «Занести в архив».",
      "Архів порожній — роздачі туди потрапляють лише за кнопкою «Занести в архів».",
      "The archive is empty — distributions land here only via the “Add to archive” button.",
    ],
    "payout.archiveExpandBtn": ["Показать", "Показати", "Show"],
    "payout.archiveCollapseBtn": ["Скрыть", "Приховати", "Hide"],
    "payout.archiveDeleteBtn": ["Удалить", "Видалити", "Delete"],
    "payout.confirmDeleteArchiveEntry": [
      "Удалить эту раздачу из архива? Это необратимо.",
      "Видалити цю роздачу з архіву? Це незворотно.",
      "Delete this distribution from the archive? This cannot be undone.",
    ],
    "payout.periodAllTimeShort": ["за всё время", "за весь час", "all time"],
    ...
    "cab.censusInClan": ["В клане — отмечен в последней переписи.", "У клані — відмічений в останньому переписі.", "In the clan — marked in the latest census."],
    "cab.censusLeftWithDate": [
      "Не в клане — последний раз отмечен в переписи от {date}.",
      "Не в клані — востаннє відмічений у переписі від {date}.",
      "Not in the clan — last marked in the census from {date}.",
    ],
    "cab.censusNeverSeen": [
      "Не в клане — в переписи вообще не встречался.",
      "Не в клані — у переписі взагалі не траплявся.",
      "Not in the clan — never appeared in the census at all.",
    ],
    "cab.censusWeeksCount": [
      "Отмечен в {n} из {total} недель переписи.",
      "Відмічений у {n} з {total} тижнів перепису.",
      "Marked in {n} of {total} census weeks.",
    ],
    "cab.taxesTitle": ["Налоги", "Податки", "Taxes"],
    "cab.taxWeeksPaid": ["Недель оплачено", "Тижнів оплачено", "Weeks paid"],
    "cab.taxDonated": ["Задонатил всего", "Задонатив всього", "Total donated"],
    "cab.colWeek": ["Неделя", "Тиждень", "Week"],
    "cab.colStatus": ["Статус", "Статус", "Status"],
    "cab.colAmount": ["Сумма", "Сума", "Amount"],
    "cab.taxNoWeeksTracked": ["Ещё нет ни одной недели с оплатами.", "Ще немає жодного тижня з оплатами.", "No weeks with payments yet."],
    "cab.taxNoDonations": ["Донатов ещё не было.", "Донатів ще не було.", "No donations yet."],
    "cab.payoutHistoryTitle": ["История выплат ДКП", "Історія виплат ДКП", "DKP payout history"],
    "cab.payoutTotalReceived": ["Всего получено", "Всього отримано", "Total received"],
    "cab.colPeriod": ["Период", "Період", "Period"],
    "cab.payoutHistoryEmpty": [
      "Пока нет истории выплат — они появляются здесь только после того, как клан-лидер занесёт раздачу в архив.",
      "Поки що немає історії виплат — вони з'являються тут лише після того, як клан-лідер занесе роздачу в архів.",
      "No payout history yet — entries appear here only after the clan leader adds a distribution to the archive.",
    ],
    "cab.taxPaidAhead": ["Оплачено (наперёд)", "Оплачено (наперед)", "Paid (in advance)"],
    ...
    "roster.tabNeverAttended": ["Не посещали", "Не відвідували", "Never attended"],
    ...
    "roster.noAttendanceListEmpty": [
      "Такие не нашлись — все хоть раз да были на мероприятии.",
      "Таких не знайшлося — всі хоч раз та були на заході.",
      "None found — everyone has attended at least one event.",
    ],
    ...
    "groups.checkColAttendance": ["Мероприятий", "Заходів", "Events"],
    "groups.checkColTax": ["Налог", "Податок", "Tax"],
    "groups.checkNoClass": ["не указан", "не вказаний", "not set"],
    "groups.checkTaxPaid": ["оплачен", "оплачений", "paid"],
    "groups.checkTaxNotPaid": ["не оплачен", "не оплачений", "not paid"],
    ...
    "admin.tabAuditLog": ["Лог действий", "Лог дій", "Action log"],
    "admin.auditLogTitle": ["Лог действий администраторов", "Лог дій адміністраторів", "Admin action log"],
    "admin.auditLogHint": [
      "Кто и что менял в Админ-панели — создание/удаление пользователей, смена роли/пати, снятие защиты, сумма налога, включение/выключение разделов. Хранятся последние 10 записей, свежие сверху.",
      "Хто і що змінював в Адмін-панелі — створення/видалення користувачів, зміна ролі/паті, зняття захисту, сума податку, увімкнення/вимкнення розділів. Зберігаються останні 10 записів, свіжі зверху.",
      "Who changed what in the Admin panel — creating/deleting users, role/party changes, removing protection, tax amount, enabling/disabling sections. The last 10 entries are kept, newest first.",
    ],
    "admin.auditColWhen": ["Когда", "Коли", "When"],
    "admin.auditColWho": ["Кто", "Хто", "Who"],
    "admin.auditColWhat": ["Что сделал", "Що зробив", "What"],
    "admin.auditLogEmpty": ["Записей ещё нет.", "Записів ще немає.", "No entries yet."],
    "admin.loadFailed": ["Не удалось загрузить: ", "Не вдалося завантажити: ", "Failed to load: "],
    "admin.auditRoleChanged": ["Сменил роль «{name}» на «{role}»", "Змінив роль «{name}» на «{role}»", "Changed role of “{name}” to “{role}”"],
    "admin.auditPartyChanged": ["Сменил пати «{name}» на «{party}»", "Змінив паті «{name}» на «{party}»", "Changed party of “{name}” to “{party}”"],
    "admin.auditProtectionRemoved": ["Снял защиту от удаления с «{name}»", "Зняв захист від видалення з «{name}»", "Removed delete protection from “{name}”"],
    "admin.auditUserDeleted": ["Удалил пользователя «{name}»", "Видалив користувача «{name}»", "Deleted user “{name}”"],
    "admin.auditUserCreated": ["Создал пользователя «{name}» ({role})", "Створив користувача «{name}» ({role})", "Created user “{name}” ({role})"],
    "admin.auditTaxAmountChanged": ["Изменил сумму налога на {val}", "Змінив суму податку на {val}", "Changed tax amount to {val}"],
    "admin.auditSectionEnabled": ["Включил раздел «{sec}» для всего клана", "Увімкнув розділ «{sec}» для всього клану", "Enabled section “{sec}” for the whole clan"],
    "admin.auditSectionDisabled": ["Отключил раздел «{sec}» для всего клана", "Вимкнув розділ «{sec}» для всього клану", "Disabled section “{sec}” for the whole clan"],
    ...
    "reports.showAllFlatBtn": ["Показывать всех", "Показувати всіх", "Show everyone"],
    "reports.showAllFlatBtnTitle": [
      "Единый список без разбивки по скринам мероприятия — все вперемешку, отсортированные по килам (или выбранной колонке) от большего к меньшему",
      "Єдиний список без розбивки по скринах заходу — усі впереміш, відсортовані за килами (або обраною колонкою) від більшого до меншого",
      "One combined list with no split by event screenshot — everyone mixed together, sorted by kills (or the selected column) from highest to lowest",
    ],
